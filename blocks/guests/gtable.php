<?php
function reloadGuests($guest){
echo "<div class='boxfull-new'>";
			$blocknumb = 0;
				foreach ($guest as $image => $value) {
				 ...
				 // }
					...
					if ($value['block'] == 1) {
						...
						echo "<div class='mute runnames blocknumb'>
							...
							<div><span class='searchasset'>".$value['name']."</span><br><span class='small'><i class=\"fa fa-inr\" aria-hidden=\"true\"></i>". ''."/-</span></div>
							...
							<span class ='action-buts' id='unblockbut".$blocknumb."' onclick='unblockGuests(this.id, \"guest-table\")'><ion-icon name='eye'></ion-icon> Unblock</span>
						...
						echo "<div class='runnames blocknumb'>
							...
							<span onclick='window.location.href=\"./slots?ewsid=".$value["uid"]."\"' class='action-buts'><ion-icon name=\"list-box\"></ion-icon> View details</span>
							<span class='action-buts edit-but runs-edit' onclick='editDropdown()' data-key='edit-run' data-value='".$value["uid"]."'><ion-icon name='create'></ion-icon> Edit</span>
							<span class ='action-buts' id='blockbut".$blocknumb."' onclick='blockGuests(this.id, \"guest-table\")'><ion-icon name='eye-off'></ion-icon> Block</span>
							<div class='delete-but'>
							<div class='delete-in'><ion-icon name='more'></ion-icon></div>
							<div class='delete-menu'>
